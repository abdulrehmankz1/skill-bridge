...
const Page = () => {
    ...
    return (
      <div className="container mx-auto pt-10 sm:pt-20 pb-16 sm:pb-32 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-11 gap-10 md:gap-20 items-center">
              ...
              <CardContent className="mt-6 sm:mt-10">
                <form>
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="grid gap-2.5 relative">
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox id="terms" className="h-5 w-5 bg-white-99 border border-white-95 text-grey-30" />
                        <label htmlFor="terms" className="text-sm sm:text-base text-grey-40 font-medium">
                          Remember Me
                        </label>
                      </div>
                    </div>
                    ...
                    {/* Google Login Button */}
                    <Button variant="secondary" size="lg" className="py-3 sm:py-4">
                      <Image
                  ...
                  <div className="mt-4 text-center text-sm text-grey-30 flex items-center justify-center">
                    ...
                    <a href="#" className="underline underline-offset-4 ml-1 flex font-semibold">
                      Sign up
